...
insert into DEPOSITER values("UDAYA",1);
insert into DEPOSITER values("LOKESH",2);
insert into DEPOSITER values("MOUNEASH",3);
insert into DEPOSITER values("VIKRAM",4);
insert into DEPOSITER values("SOMA",5);

insert into CUSTOMER values("UDAYA","CHENNAI","ANNA");
insert into CUSTOMER values("LOKESH","CHENNAI","POMBLE");
insert into CUSTOMER values("MOUNEASH","MUMBAI","MG ROAD");
insert into CUSTOMER values("VIKRAM","BANGALORE","BOMMASANDRA");
insert into CUSTOMER values("SOMA","GOA","PANAJI");
...
where accno IN (SELECT accno from ACCOUNTS 
